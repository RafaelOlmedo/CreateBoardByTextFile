...
namespace ReadTextFile
{
    class Program
    {
        ...
        {
            string sFilePath = @"C:\Users\RAFA-\Desktop\Estudo\Trello API\Projeto Estudo\";
            ...
            string[] lines = System.IO.File.ReadAllLines(sFilePath + sFile);
            ...
            var jsonString = Newtonsoft.Json.JsonConvert.SerializeObject(lstAllTopics);

            // Salva arquivo Json.
            System.IO.File.WriteAllText(sFilePath + "JSONTest.json", jsonString.ToString());
